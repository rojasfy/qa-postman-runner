...
function parseArgs() {
  ...
  return {
    ...
    folderName: params.folderName || params.folder || null,
...
function getCollectionName(collectionFile) {
  return path.basename(collectionFile || 'REGRESIVOS.postman_collection.json')
...
function createInitialProgress(params) {
  return {
    execution: {
      ...
      runId: params.runId,
      collection: getCollectionName(params.collectionFile),
...
async function run() {
  ...
  console.log('========================================');
  console.log(' QA POSTMAN RUNNER MODULAR');
  console.log('========================================');
